...
public class GlobalConquestGame : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        loadSoundEffect(GAME_EVENT_BURB_CAPTURED);
        loadSoundEffect(GAME_EVENT_BURB_LOST);
        loadSoundEffect(GAME_EVENT_ENEMY_PLAYER_LOST_GAME);
        loadSoundEffect(GAME_EVENT_ENEMY_UNIT_ATTACKED);
        loadSoundEffect(GAME_EVENT_ENEMY_UNIT_DESTROYED);
        loadSoundEffect(GAME_EVENT_PLAYER_LOST_GAME);
        loadSoundEffect("playerWonGame1");
        loadSoundEffect("playerWonGame2");
        loadSoundEffect(GAME_EVENT_UNIT_ATTACKED);
        loadSoundEffect("unitDestroyed1");
        loadSoundEffect("unitDestroyed2");
        loadSoundEffect("comcenAttacked");
        loadSoundEffect(GAME_EVENT_AIRPLANE_MISSION_SUCEEDED);
        loadSoundEffect(GAME_EVENT_AIRPLANE_MISSION_FAILED);
        loadSoundEffect(GAME_EVENT_GRACE_PERIOD_STARTED);
